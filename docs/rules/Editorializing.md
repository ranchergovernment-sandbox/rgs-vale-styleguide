...
Certain content may find it useful to disable this rule as it is directed towards technical documentation specifically. For example, a corporate blog post should disable this rule. 
